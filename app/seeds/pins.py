...
def seed_pins():
  ...
  # pin13 = Pin(
  #   owner_id=13, title="Plant Heaven At Botanical Gardens Meise - Curate And Display | Contemporary Lifestyle Product Photography | Kent", description="Giant lily pads and trailing plants inside the botanical gardens Meise", imageUrl = "https://i.pinimg.com/564x/db/d0/06/dbd0062f58da736ed26b22f9adaebed8.jpg", destinationLink = 'https://curateanddisplay.co.uk/plant-heaven-at-botanical-gardens-meise/')
